...
def seed_users():
    pw = generate_password_hash("Schm3nu!nfluencer")
    ...
    DemoUser = User(first_name="Demo",
                    ...
                    account_type="Owner", hashed_password=generate_password_hash("SchmenuP@ssword"))
    ...
    DemoLovato = User(first_name="Demo",
                      ...
                      about="I'm a demo user!",
                      profile_pix="https://i.imgur.com/AalEoSw.png",
                      account_type="Reviewer", hashed_password=generate_password_hash("SchmenuP@ssword"))
    ...
    AdamSandler = User(first_name="Adam",
                       ...
                       profile_pix="https://i.imgur.com/AalEoSw.png",
                       account_type="Owner", hashed_password=pw)
    ...
    ChanningTatum = User(first_name="Channing",
                         ...
                         profile_pix="https://i.imgur.com/AalEoSw.png",
                         account_type="Reviewer", hashed_password=pw)
